-- LU: CRecurrentAgreement
-- Table: C_RECURRENT_AGREEMENT_TAB
-- Campos: AGREEMENT_ID, OPPORTUNITY_NO, ROWSTATE
-- Quando : Alterado o ROWSTATE = Finished
-- Descr: Enviar para tela de Integração quando o Contrato mudar para o Status Finalizado 
  ...
  IF EXISTS_ORDER_NO_ IS NOT NULL THEN
    ...
    select CRA.COMPANY COMPANY,
           ...
           (select value
            ...
            CRA.MAIN_CONTACT_ID AS PERSON_ID
